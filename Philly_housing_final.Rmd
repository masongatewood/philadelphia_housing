...
lagged_philly <- philly %>%
  ...
  mutate(lagged_active_listing_count = lag(active_listing_count, n = 1, default = NA))%>%
  mutate(lagged_median_days_on_market = lag(median_days_on_market, n = 1, default = NA))%>%
  mutate(lagged_new_listing_count = lag(new_listing_count, n = 1, default = NA))%>%
  mutate(lagged_median_square_feet = lag(median_square_feet, n = 1, default = NA))%>%
  mutate(lagged_total_listing_count = lag(total_listing_count, n = 1, default = NA))
